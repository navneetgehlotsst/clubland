                ...
                <div class="card-body">
                  <div class="profile_detail_holder">
                    <div class="profile_detail_blk">
                        <form action="{{route('color_update',$data->id)}}" method="POST" enctype="multipart/form-data">
                          @csrf
                            <div class="row">
                                <div class="col-xl-6">
                                ...
                                <div class="form-group">
                                                    ...
                                                    <input type="color" class="form-control form-control-color" id="colorfield" name="color" value="{{$data->color_code}}">
                                                    @if($errors->has('color'))
                                                    <div class="error">{{ $errors->first('color') }}</div>
                                                @endif
                                </div>
                                <div class="col-xl-5">
                                        <input type="submit" value="Update" class="btn" style="color: #fff; background-color: #2fb473; border-color: #2fb473;">
                                </div>
                            </div>
                            <!-- end row -->
                        </form>
