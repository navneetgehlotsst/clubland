               ...
               <div class="row">
                  <div class="col-sm-6 page-title-box">
                     <div class="title-left">
                        <h4>Event Category Add</h4>
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <a href="{{route('event_category_page')}}" class="btn" style="float: right; color: #fff; background-color: #1E532E; border-color: #1E532E;">
                     Event Category List
                     </a>
                  </div>
               </div>
               ...
               <div class="card-body">
                  <div class="profile_detail_holder">
                     <div class="profile_detail_blk">
                        <form action="{{route('event_categroy_store')}}" method="POST" enctype="multipart/form-data">
                           @csrf
                           <div class="row">
                              <div class="col-xl-6">
                              ...
                              <div class="col-xl-5">
                                 <input type="submit" value="Submit" class="btn" style="color: #fff; background-color: #1E532E; border-color: #1E532E;">
                              </div>
                           </div>
                           <!-- end row -->
                        </form>
