         ...
         <table role="presentation" border="0" width="100%" cellspacing="0" style="margin-top: 20px;">
            <tr>
               <td bgcolor="#1e532e" align="center" style="color: white; height: 100px; padding: 20px 0px;">
                <img alt="Flower"
                src="https://cdn-icons-png.flaticon.com/512/9073/9073086.png"
                width="100px">
            </tr>
            </td>
         </table>
         ...
         <table role="presentation" border="0" width="100%" cellspacing="0">
            <tr>
               <td style="padding: 30px 30px 30px 60px;">
                  <h2 style="font-size: 28px; margin:0 0 20px 0; font-family:poppins;"> Email verification code</h2>
                  <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:poppins">Hello {{$user->full_name}},</p>
                  <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:poppins">Please use below verification code to verify your email address.</p>
                  <h1 style="font-size:22px">{{$user->otp}}</h1>
                  <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:poppins">If your email address was already verified, please ignore this email.</p>
