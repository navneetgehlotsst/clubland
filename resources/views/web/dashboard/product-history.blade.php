      ...
      <div class="row">
        ...
        <div class="right_menu">
            <div class="title_div d-flex align-items-center justify-content-between mb-20">
              ...
              <div class="titile_content">
              <a href="{{route('product_csv')}}" class="btn orange-border-btn btn-50">Download CSV</a>
              </div>
            </div>
            <!--Event list start-->
            <div class="d-block add_membership_plan p-0 my-3">
              <div class="tickets-users-list">
                <div class="card border-0">
                  <h5 class="card-header hedding-top">Product History</h5>
                      ...
                      <div class="table-responsive">
                          <table class="table">
                              ...
                              <tbody>
                                @forelse ($data as $val)
                                  <tr>
                                      <td class="align-middle text-center text-info">
                                        <a href="{{route('product_history_details',$val->id)}}" class="py-2 px-1 text-info" >#ORDERID00{{$val->booking_id}}</a></td>  
                                ...
                                @empty
                                    <tr>
                                    <td style="text-align: center;" colspan="4">No Product History Found</td>
                                    </tr>
                                @endforelse
