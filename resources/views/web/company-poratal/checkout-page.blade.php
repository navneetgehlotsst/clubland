        ...
        <div class="col-lg-12 m-auto">
          ...
          <div class="feature_content">
            ...
            <div class="feature_box bg-white">
              ...
              <form class="needs-validation" action="{{url('/payment/checkout/product')}}"  name="checkout" method="post">
                          ...
                          <div>
                            ...
                            @else
                              @if($val->getproductdata->product_discount == 0)
                                ...
                                {{$val->getproductdata['product_price'] * $val->quantity}}
                              ...
                              @else
                                ...
                                <span class="text-muted checkoutprice">
                                {{$val->getproductdata['product_discount'] * $val->quantity}}
                            ...
                            <div>
                              ...
                              <h6 class="my-0">{{ucfirst(@$res->geteventdata['name'])}}</h6>
                                ...
                                @foreach ($res->geteventticketdata as $key=> $ticket)
                                 <?php $EventAmount+= $ticket->price * $ticket->quantity; ?>
                                        ...
                                        <div class="accordion" id="accordionExample{{$ticket->id}}">
                                          ...
                                          <div class="card mt-2">
                                            ...
                                            <div class="row border-bottom border-success p-2" data-toggle="collapse" data-target="#collapseOne{{$ticket->id}}" aria-expanded="true" aria-controls="collapseOne{{$ticket->id}}">
                                              ...
                                              <div class="col-md-4 col-4 text-center text-lg-left py-1 font-weight-bold">$ <span class="totalCheckouteventPrice">{{$ticket->price * $ticket->quantity}}</span> </div>
                                                        ...
                                                        <div class="col-md-4">
                                                          ...
                                                          <div class="pb-3">
                                                            ...
                                                            <lable>Person Email</lable>
                                                                        ...
                                                                        <input type="email" required name="emails[{{$res->product_id}}][{{$ticket->id}}][{{$i}}]" class="form-control" placeholder="Email">
                                                        ...
                                                        <div class="col-md-4">
                                                          ...
                                                          <div class="pb-3">
                                                            ...
                                                            <lable>Person Phone Number</lable>
                                                                        ...
                                                                        <input type="text" required name="phone[{{$res->product_id}}][{{$ticket->id}}][{{$i}}]" class="form-control" placeholder="Phone Number">
