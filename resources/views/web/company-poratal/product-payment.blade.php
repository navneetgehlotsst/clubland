                            ...
                            <div class="row">
                                ...
                                <div class="card-body">                     
                                    ...
                                    <div class="d-flex justify-content-between mb-4">
                                        ...
                                        <p class="mb-2 font-weight-bold h5">${{number_format($finalAmount,2)}}</p>
                                    ...
                                    <div class="d-flex justify-content-between mb-4">
                                        ...
                                        <p class="mb-2 font-weight-bold h5">${{number_format($platformFee,2)}}</p>

                                    </div>

                                    <div class="d-flex justify-content-between mb-4">

                                        <p class="mb-2 h5">Total Amount</p>

                                        <p class="mb-2 font-weight-bold h5">${{number_format($finalAmount + $platformFee,2)}}</p>
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="nav-tab-card">
                                ...
                                <form id="payment-form" method="post" action="{{url('/product')}}">
                                    ...
                                    <button class="subscribe btn btn-primary btn-block" type="submit">Pay&nbsp;${{number_format($finalAmount + $platformFee,2)}}</button>
