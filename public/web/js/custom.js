...
$('#formFile').change(function () {
  var curElement = $('#perview_userprofile');
...
$(function () {
  ...
  var accordion = new Accordion($('#drop_menu'), false);
});

const leftMenu = document.getElementById('left_menu');
const closeIcon = document.getElementById('close-icon');
const leftMenuIcon = document.getElementById('left_menu_icon');
